...
weather_maps = [
    ...
    WeatherMap(eparsetype.GISMETEO_MAP, '611', '', 'https://www.gismeteo.ru/map/611/', 360*60, (55.75, 37.64, 300), emaptype.airtemperature, eregion.moscow_region, elegends.gismeteo_ru_airtemperature),
    ...
    WeatherMap(eparsetype.GISMETEO_MAP, '624', '', 'https://www.gismeteo.ru/map/624/', 360*60, (55.75, 37.64, 300), emaptype.temp_actions, eregion.moscow_region, elegends.gismeteo_ru_temp_actions),
    ...
    WeatherMap(eparsetype.GISMETEO_MAP, '647', '', 'https://www.gismeteo.ru/map/647/', 10*60, (55.75, 37.64, 300), emaptype.radar, eregion.moscow_region, elegends.gismeteo_ru_radar),
