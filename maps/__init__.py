...
weather_maps = [
    ...
    WeatherMap(GISMETEO_MAP, u'МО: Радар', '647', '', 'https://www.gismeteo.ru/map/647/', 10*60, 'moscow_region', 'radar', None),
    WeatherMap(GISMETEO_MAP, u'Сочи: Радар', '646', '', 'https://www.gismeteo.ru/map/646/', 10*60, 'sochi', 'radar', None),
